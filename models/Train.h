...
class Train
{
  public:
    struct Cols
    {
        ...
        static const std::string _coming_time;
    };
    ...
    const std::string &getValueOfComingTime() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getComingTime() const noexcept;
    ///Set the value of the column coming_time
    void setComingTime(const std::string &pComingTime) noexcept;
    void setComingTime(std::string &&pComingTime) noexcept;
    void setComingTimeToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> comingTime_;
    struct MetaData
    {
